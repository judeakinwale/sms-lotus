    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scope', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='information.scope', verbose_name='Scope')),
                ('source', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Source')),
            ],
            options={
                'verbose_name': 'Notices',
                'verbose_name_plural': 'Noticess',
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'InformationImage',
                'verbose_name_plural': 'InformationImages',
            },
        ),
        migrations.AddField(
